...
public class SettingsAppWidgetProvider extends AppWidgetProvider {
  ...
  private static final int BUTTON_APN = 5;
  private static final int BUTTON_SETTINGS = 6;
  ...
  private static final class GpsStateTracker extends StateTracker {
	...
	public int getButtonImageId(boolean on) {
	  return on ? R.drawable.ic_appwidget_settings_gps_on_holo : R.drawable.ic_appwidget_settings_gps_off_holo;
	}
...
*/
  ...
  public void onEnabled(Context context) {
	...
	pm.setComponentEnabledSetting(new ComponentName("com.android.settings", ".widget.SettingsAppWidgetProvider"), PackageManager.COMPONENT_ENABLED_STATE_ENABLED, PackageManager.DONT_KILL_APP);
  ...
  public void onDisabled(Context context) {
	PackageManager pm = context.getPackageManager();
	pm.setComponentEnabledSetting(new ComponentName("com.android.settings", ".widget.SettingsAppWidgetProvider"), PackageManager.COMPONENT_ENABLED_STATE_DISABLED, PackageManager.DONT_KILL_APP);
	if (sSettingsObserver != null) {
  ...
  static RemoteViews buildUpdate(Context context) {
	...
	views.setOnClickPendingIntent(R.id.btn_gps, getLaunchPendingIntent(context, BUTTON_GPS));
	views.setOnClickPendingIntent(R.id.btn_bluetooth, getLaunchPendingIntent(context, BUTTON_BLUETOOTH));
	views.setOnClickPendingIntent(R.id.btn_apn, getLaunchPendingIntent(context, BUTTON_APN));
	views.setOnClickPendingIntent(R.id.btn_settings, getSettingsIntent(context));
  ...
  private static PendingIntent getSettingsIntent(Context context) {
	Intent intent = new Intent(context, com.android.settings.Settings.class);
