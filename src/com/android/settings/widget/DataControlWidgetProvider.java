...
public class DataControlWidgetProvider extends AppWidgetProvider {
  ...
  static final ComponentName THIS_APPWIDGET = new ComponentName("com.android.settings", "com.android.settings.widget.DataControlWidgetProvider");
  ...
  private static final int[] ind_data_DRAWABLE_OFF = { R.drawable.appwidget_settings_ind_off_l_holo, R.drawable.appwidget_settings_ind_off_c_holo, R.drawable.appwidget_settings_ind_off_r_holo };
  ...
  private abstract static class StateTracker {
	...
	public final void setImageViewResources(Context context, RemoteViews views) {
	  ...
	  case STATE_INTERMEDIATE:
		...
		if (isTurningOn()) {
		  views.setImageViewResource(buttonId, getButtonImageId(true));
		  views.setImageViewResource(indicatorId, ind_data_DRAWABLE_MID[pos]);
		} else {
		  views.setImageViewResource(buttonId, getButtonImageId(false));
		  views.setImageViewResource(indicatorId, ind_data_DRAWABLE_OFF[pos]);
		}
  ...
  public void onEnabled(Context context) {
	...
	pm.setComponentEnabledSetting(new ComponentName("com.android.settings", ".widget.DataControlWidgetProvider"), PackageManager.COMPONENT_ENABLED_STATE_ENABLED, PackageManager.DONT_KILL_APP);
  }

  @Override
  public void onDisabled(Context context) {
	PackageManager pm = context.getPackageManager();
	pm.setComponentEnabledSetting(new ComponentName("com.android.settings", ".widget.DataControlWidgetProvider"), PackageManager.COMPONENT_ENABLED_STATE_DISABLED, PackageManager.DONT_KILL_APP);
  }
