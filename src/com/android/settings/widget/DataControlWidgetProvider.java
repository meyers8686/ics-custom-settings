...
public class DataControlWidgetProvider extends AppWidgetProvider {
	...
	static final ComponentName THIS_APPWIDGET = new ComponentName(
			...
			"com.android.settings.widget.DataControlWidgetProvider");
	...
	public void onEnabled(Context context) {
		...
		pm.setComponentEnabledSetting(new ComponentName("com.android.settings",
				".widget.DataControlWidgetProvider"),
			...
			if (buttonId == BUTTON_WIFI) {
				...
				try {
					...
					(IWindowManager.Stub.asInterface(ServiceManager
							.getService("window"))).injectKeyEvent(down, true);
					(IWindowManager.Stub.asInterface(ServiceManager
							.getService("window"))).injectKeyEvent(up, true);
